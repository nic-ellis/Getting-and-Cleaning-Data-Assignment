...
performed to clean up the data for this assignment.
...
Check the README.txt file within the data set for further details. 
...
The R script called run_analysis.R does the following five steps:

1. Merges the subject training, and test sets to create one data set.
...
average of each variable for each activity and each subject, a copy of which is
included in this repo under the title Class Assignment Output.txt